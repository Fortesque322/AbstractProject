...
begin
  SetLength(Result, SizeOf(FPrice) + Length(FModel) + SizeOf(FTotal) + SizeOf(integer));
  ...
  Move(TEncoding.UTF8.GetBytes(FModel)[0],Result[Counter],Length(FModel));
